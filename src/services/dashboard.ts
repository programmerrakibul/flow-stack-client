...
export const dashboardService = {
  getUserDashboard: async () => {
    const { data } = await api.get<TSuccessResponse<TUserDashboard>>("/dashboard/user");
    return data;
  },

  getAdminDashboard: async () => {
    const { data } = await api.get<TSuccessResponse<TAdminDashboard>>("/dashboard/admin");
    return data;
  },
  ...
  getAllTasks: async (params?: {
    ...
    const { data } = await api.get<TSuccessResponse<TTask[]>>("/tasks", { params });
    return data;
  },
};
