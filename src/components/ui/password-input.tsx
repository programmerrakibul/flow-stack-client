...
export const PasswordInputGroup = (
  ...
  return (
    <ArkPasswordInput.Control data-slot="password-input-control" render={<InputGroup className={cn(
                "in-data-[size=lg]:h-9 in-data-[size=sm]:h-7",
                "data-disabled:pointer-events-none data-disabled:opacity-64",
                className
              )} {...rest} />}></ArkPasswordInput.Control>
  );
};
...
export const PasswordInputInput = (
  ...
  <ArkPasswordInput.Input data-slot="password-input-input" {...props} render={<InputGroupInput />}></ArkPasswordInput.Input>
);
...
export const PasswordInputTrigger = (
  ...
  return (
    <InputGroupAddon align="inline-end">
      <ArkPasswordInput.VisibilityTrigger data-slot="password-input-visibility-trigger" render={<InputGroupButton size="icon-xs" variant="ghost" {...rest} />}>{children ?? <PasswordInputIndicator />}</ArkPasswordInput.VisibilityTrigger>
    </InputGroupAddon>
  );
};
